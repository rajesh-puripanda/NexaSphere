        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            ...
            >
              ...
              >
                <DynamicIcon name="MapPin" size={14} /> GL Bajaj Group of
              ...
              >
                <DynamicIcon name="CheckCircle" size={12} /> Completed
              </span>
            </div>
        ...
        >
          ...
          <section>
            ...
            {!event.photoLink && !event.videoLink && (
              ...
              >
                Add links in{" "}
                <code style={{ color }}>src/data/activityPagesData.js</code> →
                KSS #153 → <code style={{ color }}>photoLink</code> /{" "}
                <code style={{ color }}>videoLink</code>
              </p>
            )}
          </section>
